...
<link rel="stylesheet" type="text/css"
	href="<c:url value="${pageContext.request.contextPath}/resource/css/aboutus.css"/>">
...
<!-- Content -->
	<div class="row" style="margin-top:4px; margin-right:0px; margin-left:0px;margin-bottom:19px; height: 100vh; ">
		<div class="col-sm-4" style="margin-top:0px">
			<div class="container-fluid bg-1 text-center">
				<h3>Who Am I?</h3>
				<img src="<c:url value="${pageContext.request.contextPath}/resource/images/aboutImage.png"/>" class="img-circle" alt="AboutUs" width="350"
					height="350">
				<h3>Smart Phamarcy a WorldWide E-Commerce Site</h3>
			</div>
		...
		<div class="container-fluid bg-2 text-center">
			<h3>What Am I?</h3>
			<div id="para"><p>Smart Phamarcy's vision is to create India's most reliable and
