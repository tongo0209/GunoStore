...
<link rel="stylesheet" type="text/css"
	href="<c:url value="${pageContext.request.contextPath}/resource/css/ProductList.css"/>">
<script
	src="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.8/angular.min.js"></script>
<script src="<c:url value="${pageContext.request.contextPath}/resource/js/productController.js"/>"></script>
</head>
<body ng-app="myapp">
	<div class="container" id="productTable"
		style="width: 1145px; margin-bottom: 180px;height: 100vh;">
				...
				<c:forEach items="${products}" var="prod">
					...
					<tr>
						<td style="width: 171px"><img
							src="<c:url value="${pageContext.request.contextPath}/resource/images/products/${prod.productId}.jpg"/>"
