...
<link rel="stylesheet"
	href="<c:url value="${pageContext.request.contextPath}/resource/css/form-elements.css"/>">
<link rel="stylesheet" href="<c:url value="${pageContext.request.contextPath}/resource/css/style.css"/>">
...
<script src="<c:url value="${pageContext.request.contextPath}/resource/js/retina-1.1.0.min.js"/>"></script>
<script src="<c:url value="${pageContext.request.contextPath}/resource/js/scripts.js"/>"></script>
<style>
body {
	background-image: url("<c:url value="${pageContext.request.contextPath}/resource/images/1.jpg "/>");
}
</style>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2 text">
					<h1>
						<strong>Smart Phamarcy</strong> Contact Form
					</h1>
					...
					<div class="form-bottom contact-form">
						...
						<form:form role="form" method="post" action="${url}"
                                                    ...
                                                    <button style="float: right;" type="button" class="btn"
                                                            onclick="window.location.href='<c:url value="/trang-chu" />'">Back
                                                            to Home</button>
						</form:form>
					</div>
				</div>
