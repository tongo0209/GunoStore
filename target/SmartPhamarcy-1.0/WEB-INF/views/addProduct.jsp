...
<body>
	...
	<div class="container" style="margin-bottom:19px; height: 100vh;">
		<h1 class="well text-center">Add Product !</h1>
				...
				<form:form method="post" action="${url}" commandName="productFormObj" enctype="multipart/form-data">
					<div class="col-sm-12">
						...
						<form:label path="productCategory">Product Category</form:label>
								<form:textarea type="text"
									placeholder="Enter Product Category.." class="form-control"
									path="productCategory"></form:textarea>
						</div>
						<div class="row">
					 	...
					 	<div class="form-group">
						<form:label path="productImgFile">Product Image</form:label>
							<form:input type="file" path="productImgFile"/>
						</div>  
