			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="<c:url value="${pageContext.request.contextPath}/resource/images/oppo.jpg"/>" alt="Image1"
							width="460" height="345">
					</div>

					<div class="item">
						<img src="<c:url value="${pageContext.request.contextPath}/resource/images/oppo1.jpg"/>"
							alt="Image2" width="460" height="345">
					</div>

					<div class="item">
						<img src="<c:url value="${pageContext.request.contextPath}/resource/images/oppo2.jpg"/>"
							alt="Image3" width="460" height="345">
					</div>

					<div class="item">
						<img src="<c:url value="${pageContext.request.contextPath}/resource/images/oppo3.jpg"/>"
							alt="Image4" width="460" height="345">
					</div>

					<div class="item">
						<img src="<c:url value="${pageContext.request.contextPath}/resource/images/oppo4.jpg"/>"
